;(function ($, window, document, undefined) {
  ...
  var Orbit = function(el, settings) {
    ...
    self.build_markup = function() {
      ...
      if (settings.navigation_arrows) {
        bullets_container.append($('<a href="#"><span></span></a>').addClass(settings.prev_class));
        bullets_container.append($('<a href="#"><span></span></a>').addClass(settings.next_class));
      }
  ...
  Foundation.libs.orbit = {
    ...
    settings: {
      animation: 'slide', // peut être fade
      timer_speed: 10000,
      pause_on_hover: true,
